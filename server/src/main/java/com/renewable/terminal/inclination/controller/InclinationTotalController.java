 ...
 */
@RestController
@RequestMapping("/inclination_total/")
public class InclinationTotalController {
	...
	public ServerResponse listByTimeWithCount(@RequestParam(value = "count", defaultValue = "1024") Integer count,
		...
		return iInclinationTotalService.listByTimeWithCount(count, startTime, endTime);
	}
	...
	public ServerResponse cleanDataPersistence() {
		return iInclinationTotalService.cleanDataPersistence();
	}
}
