 ...
 * @Author: jarry
 */
@Component("Origin2Command526T")
@Slf4j
public class Origin2Command526T implements Origin2Command {
...
//		int dataAreaSingleDataCount = 3;
	...
	public ServerResponse origin2Object(SerialPort serialPort, byte[] originBuffer) {
		...
		log.info("System has choose the sensor about Inclination526T,data:{}", Arrays.toString(originBuffer));
...
//				originBuffer);
	...
	public ServerResponse origin2SetZeroResponse(byte[] originBuffer) {
		return null;
	}


	public ServerResponse origin2GetZeroResponse(byte[] originBuffer) {
		return null;
	}


	public ServerResponse origin2SetAddressResponse(byte[] originBuffer) {
		return null;
	}


	public ServerResponse origin2ModelResponse(byte[] originBuffer) {
		return null;
	}


	public ServerResponse origin2SetSpeedResponse(byte[] originBuffer) {
		return null;
	}
}
