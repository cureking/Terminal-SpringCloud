...
public class OtherUtil {
	...
	public static double[] calInitAngleTotal(double angleX, double angleY, double angleInit, double X, double Y, InclinationConfigConstant.InclinationInstallModeEnum installModeEnum) {
